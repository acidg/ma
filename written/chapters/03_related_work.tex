...
\todo[inline]{Rewrite most of chapter, concentrate on continuous detection}
...
However, \glqq evaluation shows that [their] approach is faster than index-based techniques when the analysis is run only once. If the analysis is to be conducted multiple times, creating an index pays off\grqq \cite{koschke2014large}.\todo{Continuous detection}
